...
export const ENV = {
  ...
  LIVEKIT_ENABLED: process.env.LIVEKIT_ENABLED || 'false',
  LIVEKIT_URL: process.env.LIVEKIT_URL || '',
  LIVEKIT_API_KEY: process.env.LIVEKIT_API_KEY || '',
  LIVEKIT_API_SECRET: process.env.LIVEKIT_API_SECRET || '',
  LIVEKIT_TOKEN_TTL_SECONDS: Number(process.env.LIVEKIT_TOKEN_TTL_SECONDS || 60 * 60),
  ...
  NOTIFICATION_EMAIL_WEBHOOK_URL: process.env.NOTIFICATION_EMAIL_WEBHOOK_URL || process.env.HOST_ALERT_EMAIL_WEBHOOK_URL || '',
  NOTIFICATION_WEBHOOK_SECRET: process.env.NOTIFICATION_WEBHOOK_SECRET || process.env.HOST_ALERT_WEBHOOK_SECRET || '',
  NOTIFICATION_FROM_NAME: process.env.NOTIFICATION_FROM_NAME || 'Meetra',
  NOTIFICATION_FROM_EMAIL: process.env.NOTIFICATION_FROM_EMAIL || '',
  NOTIFICATIONS_STORE_FILE: process.env.NOTIFICATIONS_STORE_FILE || 'server/data/notifications/email-outbox.json',
